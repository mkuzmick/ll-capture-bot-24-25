...
const modHebrewChannel = "C082UADJLP9";
const compLitChannel = "C07QLLCCVKL";

const rainbowChannel = compLitChannel;
...
const modernHebrewConfig = {
  scenes: [
    {
      name: "Student 1",
      channel: modHebrewChannel,
      track: "a8k_03",
      color: "gray",
      icon: "https://files.slack.com/files-pri/T0HTW3H0V-F06T3AKR886/red.webp?pub_secret=9c8372302a"
    },
...
const customConfig = compLitConfig;
